...
public://public member functions
    ...
    int j_detail() // function declaration and definition for domestic journey
    {
        ...
        cin >> doj;
        cout << "\1.New Delhi(1) \t\2.Mumbai(2) \t\3.Chennai(3) \t\4.Kolkata(4)" << endl << endl;
...
public://public member functions
    ...
    int j_detaili()// function declaration and definition for journey details
    {
        ...
        cin >> doji;
        cout << "\1.New Delhi(1) \2.Mumbai(2) \3.Abu Dhabi(3) \4.Singapore(4) \5.Newark(5) " << endl << endl;
        cout << "\tEnter Source" << endl;
        cin >> srci;
        cout << "\nEnter destination" ;
        cin >> desti;
...
public://public members functions
    ...
    {     cout << "\n\n\nHow would you like to pay?:\n";
        ...
        case 2://condition
            ...
            break;
        case 3://condition
            cout << "Banks Available: \1.ICICI Bank(1) \2.SBI Bank(2) \3.HDFC Bank(3) \4.RBI Bank(4) \5.Others(5)";
            cout << "\nSelect your bank:";
            cin >> bank;
...
int main()//main function
{
    ...
    do//do while loop
    {
    cout << "\t \t \t Welcome To YourTicket.com!" << endl << endl;
    cout << "\t Now Book your Flight tickets at affordable prices!" << endl;
    cout << "\t \t \t \t \t \t \t \tCall: 0123456789" << endl << endl << endl;
